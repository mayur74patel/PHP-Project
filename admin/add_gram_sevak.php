...
if (isset($_POST['submitdata']) && $_POST['submitdata'] == 'Save') {
    $gram_sevak_name = $_POST['gram_sevak_name'];   
...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
    ...
    $addcategory = addgram_sevak($gram_sevak_name,$mobile_no,$fb_id,$email_id,$insta_id,$twitter_id,$newfilename);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Name*</label>                                
                                    <input type="text" class="form-control" id="gram_sevak_name" name="gram_sevak_name" required onkeypress="return spacerestri(event, this);">                                
                                </div>                               
                                <div class="form-group">
