                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                ...
                                <li id="Header_A7" class="active"><a href="development.php">વિકાસના કામ</a> </li>
...
<form>
                ...
                <div class="body-content" style="background-color: beige; margin-top: -28px;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="heading-title">વિકાસના કામની વિગત</h2>
                                    ...
                                    <div class="shopping-cart-table ">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th class="cart-description item">અ.નં.</th>
                                                        <th class="cart-qty item">કામનું નામ</th>
                                                        <th class="cart-product-name item"> ગ્રાન્ટની રકમ</th>
                                                        <th class="cart-edit item">કામનું વર્ષ</th>
                                                        <th class="cart-qty item">યોજનાની વિગત</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
														<?php
